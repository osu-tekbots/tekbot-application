...
*/
		...
		foreach ($stations AS $s){
				$qrCode = "<img style='width:1.8in;height:1.8in;' src='createqr.php?data=https://eecs.engineering.oregonstate.edu/education/tekbotSuite/tekbot/pages/publicTicketSubmit.php?station=".$s->getId()."'>";
