...
$tool_id = 7; //7 will be tickets id in messages db
...
$title = 'Employee Ticket Messages';
$css = array(
            ...
            <?php 
                ...
                foreach ($messages as $m) {
					...
					echo '<div class="form-group row">
							...
							<div class="col-sm-8"><textarea type="text" rows="5" class="form-control" id="body'.$message_id.'">'.$body.'</textarea></div>
