...
$title = 'Employee Internal Sales Messages';
$css = array(
            ...
            <?php 
                ...
                foreach ($messages as $m) {
					...
					echo '<div class="form-group row">
							...
							{{transactions}}: A list of all unprocessed transactions' . 
							/* Old inserts; not currently implemented by TekBotsMailer
							{{buyer}}: Buyer Full Name<BR>
							{{seller}}: Seller Full Name<BR>
							{{amount}}: Cost Amount<BR>
